<?php if (!defined('THINK_PATH')) exit();?><div class="pageHeader">
	<form id="pagerForm" action="/index.php/Admin/Goods" method="post" onSubmit="return navTabSearch(this)">
        ...
        <div class="searchBar">
        	<ul class="searchContent">
                ...
                <li>
                	<label>商品名称：</label>
                    <input name="goods_name" type="text" size="20" />
                </li>
            </ul>
            <div class="subBar"> 
            	<ul>
...
<div class="pageContent">
    ...
    <div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="/index.php/Admin/Goods/add/navTabId/<?php echo (strtolower(CONTROLLER_NAME)); ?>_<?php echo (strtolower(ACTION_NAME)); ?>" target="dialog" mask="true" maxable="false" width="800" height="550" rel="goods_add"><span>新增</span></a></li>
			<li><a class="delete" href="/index.php/Admin/Goods/foreverdelete/navTabId/<?php echo (strtolower(CONTROLLER_NAME)); ?>_<?php echo (strtolower(ACTION_NAME)); ?>" posttype="string" rel="id" target="selectedTodo" title="确定要删除选中的记录吗？" warn="请至少选择一位用户"><span>删除</span></a></li>
			<li><a class="edit" href="/index.php/Admin/Goods/edit/navTabId/<?php echo (strtolower(CONTROLLER_NAME)); ?>_<?php echo (strtolower(ACTION_NAME)); ?>/id/{sid_user}" target="dialog" warn="请选择一个用户" width="800" height="550" rel="goods_edit"><span>编辑</span></a></li>
		</ul>
	</div>
    <!--数据显示-->
    <table class="list" width="100%" layoutH="140">
		<thead>
			<tr>
				<th width="10%" align="center"><input type="checkbox" group="id" class="checkboxCtrl"></th>
				<th width="10%">编号</th>
                <th width="30%">商品名称</th>
                <th width="10%">价格</th>
                <th width="10%">上架</th>
