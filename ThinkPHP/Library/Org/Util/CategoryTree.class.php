...
class CategoryTree
{
    ...
    */
    function get_parent($myid)
    {
        ...
        $pid = $this->arr[$myid]['cat_pid'];
        $pid = $this->arr[$pid]['cat_pid'];
        if(is_array($this->arr))
        {
            foreach($this->arr as $id => $a)
            {
                if($a['cat_pid'] == $pid) $newarr[$id] = $a;
            }
        }
        return $newarr;
    }
